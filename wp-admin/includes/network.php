...
function network_step1( $errors = false ) {
    ...
    <table class="form-table" role="presentation">
        ...
        <tr>
            ...
            <td>
                <input name='sitename' id='sitename' type='text' size='45'
...
<configuration>
    <system.webServer>
		...
		if ( Load::is_multisite() && get_site_option( 'ms_files_rewriting' ) ) {
			$web_config_file .= '
