...
class Load
{
	 ...
	 */
	static function wp_fix_server_vars()
	{
		global $PHP_SELF;
	 ...
	 * @since 5.6.0
	 */
	static function wp_populate_basic_auth_from_authorization_header()
	{
	 ...
	 */
	static function wp_check_php_mysql_versions()
	{
	 ...
	 */
	static function wp_get_environment_type()
	{
		static $current_env = '';
	 ...
	 */
	static function wp_favicon_request()
	{
	 ...
	 */
	static function wp_is_maintenance_mode()
	{
		global $upgrading;
	...
	/**
	 * Retrieve or display the time from the page start to when static function is called.
	 *
	 * @since 0.71
	 *
	 * @global float   $timestart Seconds from when timer_start() is called.
	 * @global float   $timeend   Seconds from when static function is called.
	 *
	 ...
	 */
	static function timer_stop($display = 0, $precision = 3)
	{
	 ...
	 *
	 * `WP_DEBUG_DISPLAY` and `WP_DEBUG_LOG` perform no static function unless `WP_DEBUG`
	 * is true.
	 *
	 ...
	 * @access private
	 */
	static function wp_set_lang_dir()
	{
	 ...
	 */
	static function wp_set_wpdb_vars()
	{
	 ...
	 */
	static function wp_start_object_cache()
	{
		global $wp_filter;
	 ...
	 */
	static function wp_get_mu_plugins()
	{
		$mu_plugins = array();
	 ...
	 */
	static function wp_get_active_and_valid_plugins()
	{
		$plugins        = array();
	 ...
	 */
	static function wp_skip_paused_plugins(array $plugins)
	{
	 ...
	 */
	static function wp_get_active_and_valid_themes()
	{
		global $pagenow;
	 ...
	 */
	static function wp_skip_paused_themes(array $themes)
	{
	 ...
	 * @return bool
	 */
	static function wp_is_recovery_mode()
	{
	 ...
	 */
	static function is_protected_endpoint()
	{
		// Protect login pages.
	 ...
	 */
	static function is_protected_ajax_action()
	{
		if (!wp_doing_ajax()) {
			return false;
		}
	 ...
	 * @access private
	 */
	static function wp_set_internal_encoding()
	{
	 ...
	 * @access private
	 */
	static function wp_magic_quotes()
	{
		// Escape with wpdb.
	 ...
	 * @access private
	 */
	static function shutdown_action_hook()
	{
		/**
	 ...
	 */
	static function wp_clone($object)
	{
	 ...
	 */
	static function is_network_admin()
	{
		if (isset($GLOBALS['current_screen'])) {
	 ...
	 * @return int Site ID.
	 */
	static function get_current_blog_id()
	{
		global $blog_id;
	 ...
	 */
	static function wp_load_translations_early()
	{
		global $wp_locale;
	 ...
	 * @return bool True if WP is installing, otherwise false. When a `$is_installing` is passed, the static function will
	 *              report whether WP was in installing mode prior to the change to `$is_installing`.
	 */
	static function wp_installing($is_installing = null)
	{
	 ...
	 */
	static function wp_convert_hr_to_bytes($value)
	{
	 ...
	 */
	static function wp_is_ini_value_changeable($setting)
	{
		static $ini_all;
	 ...
	 */
	static function wp_using_themes()
	{
		/**
	 ...
	 */
	static function is_wp_error($thing)
	{
	 ...
	 */
	static function wp_is_file_mod_allowed($context)
	{
		/**
	 ...
	 * @since 4.9.0
	 */
	static function wp_start_scraping_edited_file_errors()
	{
	 ...
	 */
	static function wp_finalize_scraping_edited_file_errors($scrape_key)
	{
	 ...
	 */
	static function wp_is_jsonp_request()
	{
	 ...
	 */
	static function wp_is_json_media_type($media_type)
	{
		static $cache = array();
	 ...
	 */
	static function wp_is_xml_request()
	{
		$accepted = array(
			'text/xml',
			'application/rss+xml',
