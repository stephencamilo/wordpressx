...
class L10n
{
	 ...
	 *
	 * *Note:* Don't use self::translate() directly, use __() or related functions.
	 *
	 * @since 2.2.0
	...
	{
		$translations = self::get_translations_for_domain($domain);
		$translation  = $translations->self::translate($text, $context);
	 ...
	 * @access private
	 *
	 * @see self::get_translations_for_domain()
	 * @global MO[] $l10n_unloaded An array of all text domains that have been unloaded again.
	 *
	 * @param string $domain Text domain. Unique identifier for retrieving translated strings.
	...
	{
		global $l10n;
		if (isset($l10n[$domain]) || (self::_load_textdomain_just_in_time($domain) && isset($l10n[$domain]))) {
			return $l10n[$domain];
		}
