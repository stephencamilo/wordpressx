...
class TranslationInstall
{
	static function translations_api($type, $args = null)
	{
	...
	static function wp_get_available_translations()
	{
		if (!wp_installing()) {
		...
		$api = self::translations_api('core', array('version' => $wp_version));
	...
	static function wp_install_language_form($languages)
	{
	...
	static function wp_download_language_pack($download)
	{
		...
		$translations = self::wp_get_available_translations();
		if (!$translations) {
			return false;
		}
	...
	static function wp_can_install_language_pack()
	{
