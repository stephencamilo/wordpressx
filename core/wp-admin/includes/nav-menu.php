...
require_once ABSPATH_CORE . 'wp-admin/includes/class-walker-nav-menu-edit.php';

/** Walker_Nav_Menu_Checklist class */
require_once ABSPATH_CORE . 'wp-admin/includes/class-walker-nav-menu-checklist.php';
