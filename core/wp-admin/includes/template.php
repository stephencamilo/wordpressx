...
require_once ABSPATH_CORE . 'wp-admin/includes/class-walker-category-checklist.php';

/** WP_Internal_Pointers class */
require_once ABSPATH_CORE . 'wp-admin/includes/class-wp-internal-pointers.php';
