...
jQuery(document).ready(function ( $ ) {
    ...
    $('.export-personal-data-handle').click(function ( event ) {
        ...
        function onExportDoneSuccess( zipUrl )
        {
            ...
            setTimeout(function () {
                $rowActions.removeClass('processing'); }, 500);
        }
        ...
        function doNextExport( exporterIndex, pageIndex )
        {
            $.ajax(
                ...
                if ( ! response.success ) {
                    ...
                    setTimeout(function () {
                        onExportFailure(response.data); }, 500);
                    return;
                }
                ...
                if ( ! responseData.done ) {
                    ...
                    if ( exporterIndex < exportersCount ) {
                        ...
                        setTimeout(function () {
                            onExportDoneSuccess(responseData.url); }, 500);
                    }
                }
            }).fail(function ( jqxhr, textStatus, error ) {
                // e.g. Nonce failure.
                setTimeout(function () {
                    onExportFailure(error); }, 500);
            });
        }
