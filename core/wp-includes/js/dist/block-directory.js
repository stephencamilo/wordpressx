...
/******/ })({
            ...
            for (var i = 1; i < arguments.length; i++) {
                var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) {
                    ownKeys(Object(source), true).forEach(function (key) {
                        Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) {
    ...
    */
        ...
        function DownloadableBlockAuthorInfo(_ref)
        {
          ...
          /* translators: 1: number of blocks. 2: average rating. */
                Object(external_this_wp_i18n_["_n"])('This author has %1$d block, with an average rating of %2$.1f.', 'This author has %1$d blocks, with an average rating of %2$.1f.', authorBlockCount),
                authorBlockCount,
                authorBlockRating
            ) : Object(external_this_wp_i18n_["sprintf"])(
          /* translators: 1: number of blocks. */
                Object(external_this_wp_i18n_["_n"])('This author has %1$d block.', 'This author has %1$d blocks.', authorBlockCount),
                authorBlockCount
            )));
        }
        ...
        var block_ratings_BlockRatings = function BlockRatings(_ref)
        {
            ...
            return Object(external_this_wp_element_["createElement"])("div", {
                ...
                "aria-label": Object(external_this_wp_i18n_["sprintf"])( // translators: %d: number of ratings (number).
                    Object(external_this_wp_i18n_["_n"])('%d total rating', '%d total ratings', ratingCount),
                    ratingCount
                )
            }, "(", ratingCount, ")"));
        };
        ...
        function DownloadableBlockIcon(_ref)
        {
            ...
            return Object(external_this_wp_element_["createElement"])("div", {
                ...
                alt: Object(external_this_wp_i18n_["sprintf"])( // translators: %s: Name of the plugin e.g: "Akismet".
                    Object(external_this_wp_i18n_["__"])('%s block icon'),
                    title
                )
    ...
    */
        ...
        function DownloadableBlockInfo(_ref)
        {
          ...
          /* translators: %d: number of active installations. */
                    Object(external_this_wp_i18n_["__"])('%d+ Million active installations'),
                ...
                activeInstallsString = Object(external_this_wp_i18n_["sprintf"])(
      /* translators: %d: number of active installations. */
                    Object(external_this_wp_i18n_["__"])('%d+ active installations'),
                    activeInstalls
                );
            }
            ...
            return Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, Object(external_this_wp_element_["createElement"])("p", {
                ...
                icon: chart_line
            }), activeInstallsString), Object(external_this_wp_element_["createElement"])(
                "div",
                {
                    className: "block-directory-downloadable-block-info__meta"
                },
    ...
    */
    ...
    /* translators: %s: number of available blocks. */
                Object(external_this_wp_i18n_["_n"])('No blocks found in your library. We did find %d block available for download.', 'No blocks found in your library. We did find %d blocks available for download.', downloadableItems.length),
    ...
    */
        ...
        function CompactList(_ref)
        {
          ...
          /* translators: %s: Name of the block author. */
                    Object(external_this_wp_i18n_["__"])('By %s'),
                    author
                ))));
            }));
        }
        ...
        function InstalledBlocksPrePublishPanel()
        {
            ...
            return Object(external_this_wp_element_["createElement"])(external_this_wp_editPost_["PluginPrePublishPanel"], {
                ...
                title: Object(external_this_wp_i18n_["sprintf"])( // translators: %d: number of blocks (number).
                    Object(external_this_wp_i18n_["_n"])('Added: %d block', 'Added: %d blocks', newBlockTypes.length),
    ...
    */
        ...
        function InstallButton(_ref)
        {
          ...
          /* translators: %s: block name */
                Object(external_this_wp_i18n_["__"])('Install %s'),
                block.title
            ));
        }
    ...
    */
        ...
        var get_install_missing_getInstallMissing = function getInstallMissing(OriginalComponent)
        {
          ...
          /* translators: %s: block name */
                    Object(external_this_wp_i18n_["__"])('Your site doesn’t include support for the %s block. You can try installing the block or remove it entirely.'),
                ...
                if (hasContent && hasHTMLBlock) {
                        ...
                        /* translators: %s: block name */
                            Object(external_this_wp_i18n_["__"])('Your site doesn’t include support for the %s block. You can try installing the block, convert it to a Custom HTML block, or remove it entirely.'),
                            block.title || originalName
                        );
