            ...
            if (!n[i]) {
                if (!e[i]) {
                    var c="function"==typeof require&&require;if (!f&&c) {
                        ...
                        var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for (var u="function"==typeof require&&require,i=0; i<t.length; i++) {
                o(t[i]);
                        }return o}return r})()({1:[function (_dereq_,module,exports) {
                            "use strict";
                        ...
                        // https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
                          ...
                          // eslint-disable-next-line no-new-func
                            ...
                            module.exports = !_dereq_(20) && !_dereq_(23)(function () {
                                return Object.defineProperty(_dereq_(21)('div'), 'a', { get: function () {
                                    return 7; } }).a != 7;
                            });
    ...
    // eslint-disable-next-line no-unused-vars
                            ...
                            // 19.2.3.6 Function.prototype[@@hasInstance](V)
                                if (!(HAS_INSTANCE in FunctionProto)) {
                                    _dereq_(99).f(FunctionProto, HAS_INSTANCE, { value: function (O) {
                                    ...
                                    $Number = function Number(value)
                                    {
                                      ...
                                      // check on 1..constructor(foo) case
                                        && (BROKEN_COF ? fails(function () {
                                            proto.valueOf.call(that); }) : cof(that) != NUMBER)
