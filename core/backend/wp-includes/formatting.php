...
function _print_emoji_detection_script() {
	...
	if ( SCRIPT_DEBUG ) {
		...
		<script<?php echo $type_attr; ?>>
			...
			<?php readfile( ABSPATH_FRONTEND . WPINC . '/js/wp-emoji-loader.js' ); ?>
		</script>
		<?php
	} else {
		$settings['source'] = array(
			/** This filter is documented in wp-includes/class.wp-scripts.php */
			'concatemoji' => apply_filters( 'script_loader_src', frontend_includes_url( "js/wp-emoji-release.min.js?$version" ), 'concatemoji' ),
		);
		...
		<script<?php echo $type_attr; ?>>
			...
			function l(e) {
				...
				function d(e) {
					...
					t.src = window.location.origin+e, t.defer = t.type = "text/javascript", a.getElementsByTagName("head")[0].appendChild(t)
				}
