...
function wp_default_scripts( $scripts ) {
	...
	$scripts->add( 'common', "/wp-admin/js/common$suffix.js", $scripts_to_load, false, 1 );
	...
	$scripts->add( 'clipboard', "/wp-includes/js/clipboard$suffix.js", [], false, 1 );
	...
	$scripts->add( 'jquery-core', "/wp-includes/js/jquery/jquery$suffix.js", [], '3.5.1' );
	$scripts->add( 'jquery-migrate', "/wp-includes/js/jquery/jquery-migrate$suffix.js", [], '3.3.2' );
	...
	$scripts->add( 'mediaelement-core', "/wp-includes/js/mediaelement/mediaelement-and-player$suffix.js", [], '4.2.16', 1 );
...
function wp_default_styles( $styles ) {
	...
	$styles->add( 'mediaelement', '/wp-includes/js/mediaelement/mediaelementplayer-legacy.min.css', [], '4.2.16' );
